...
class LMStudioClient:
    ...
    async def generate(self, prompt: str, model: Optional[str] = None,
                      ...
                      conversation_history: Optional[List[tuple]] = None) -> Optional[str]:
        ...
        # Build messages for chat completion (now with conversation history)
    ...
    def _build_messages(self, user_prompt: str, context: Optional[str] = None,
        ...
        # Add context if available (RAG injection)
